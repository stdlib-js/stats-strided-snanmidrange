...
var snanmidrange = tryRequire( resolve( __dirname, './../lib/snanmidrange.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 3', opts, function test( t ) {
	t.strictEqual( snanmidrange.length, 3, 'has expected arity' );
	t.end();
});
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns `NaN`', opts, function test( t ) {
	...
	v = snanmidrange( 0, x, 1 );
	t.strictEqual( isnanf( v ), true, 'returns expected value' );

	v = snanmidrange( -1, x, 1 );
	t.strictEqual( isnanf( v ), true, 'returns expected value' );
