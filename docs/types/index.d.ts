...
/**
* Interface describing `snanmidrange`.
*/
interface Routine {
	/**
	...
	*/
	...
	/**
	* Computes the mid-range of a single-precision floating-point strided array, ignoring `NaN` values and using alternative indexing semantics.
	*
	* @param N - number of indexed elements
	* @param x - input array
	* @param strideX - stride length
...
* // returns 0.0
*/
declare var snanmidrange: Routine;
